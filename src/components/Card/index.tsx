  ...
  return (
    <div className="flex md:justify-between items-center md:items-start basis-1/3 md:gap-4 gap-2 md:flex-col flex-row ">
      ...
      <div className="gap-1 flex flex-col">
        ...
        <span data-testid="availability" aria-label="pet is available">
          {`Available: `}
      ...
      <Link
        ...
        href="#petDetail"
        className="hidden md:flex md:w-full lg:w-fit hover:drop-shadow-lg bg-vibrant-blue text-white py-2 px-4 rounded-lg justify-center items-center min-w-32 text-2xl gap-2"
